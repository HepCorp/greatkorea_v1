			...
			<div id="greetingCon" class="contentWrap">
				<div id="greetingBox">
					...
					<div id="greeting02">
						...
						<div id="ceoCha">
							<img src="<c:url value="/resources/img/ceo_cha.png" />" alt="씨이오 캐리커쳐 이미지" />
						</div>

						<div id="greetingArticle03">
							<div id="campaign">
								<img src="<c:url value="/resources/img/campaign.png" />" alt="캠페인 이미지" />
							</div>
							<div id="ceo">
								<p>실전화이트해커그룹 CEO[이사회/의장]</p>
								<div id="sign">
									<img src="<c:url value="/resources/img/ceo_sign.png" />"
										alt="씨이오 싸인 이미지" />
								</div>
							</div>
						</div>

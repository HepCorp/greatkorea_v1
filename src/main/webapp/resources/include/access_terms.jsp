<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<div id="access_terms" class="access_div" style="display:none;">
		<p class="close"><a href="#" class="access_close"><img src="/resources/img/close_btn.png" alt="close" /></a></p>
		<div class="access_inner">
			<h1>이용약관</h1>
			  <section>
	              <div class="text">
	                  <ul>
		                  <li><span>제 1 조 (목적)</span><br>
		                  	이 약관은 헤프 주식회사 ("회사" 또는 "헤프")가 제공하는 헤프 및 헤프 관련 제반 서비스의 이용과 관련하여 회사와 회원과의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.</li>
		                  <li><span>제 2 조 (정의)</span><br>
							...
							⑤"게시물"이라 함은 "회원"이 "서비스"를 이용함에 있어 "서비스상"에 게시한 부호ㆍ문자 등의 정보 형태의 글, 사진과 링크 등을 의미합니다.</li>
		                  <li><span>제 3 조 (약관의 게시와 개정)</span><br>
							...
							⑤회원이 개정약관의 적용에 동의하지 않는 경우 회사는 개정 약관의 내용을 적용할 수 없으며, 이 경우 회원은 이용계약을 해지할 수 있습니다. 다만, 기존 약관을 적용할 수 없는 특별한 사정이 있는 경우에는 회사는 이용계약을 해지할 수 있습니다.</li>
		                  <li><span>제 4 조 (약관의 해석)</span><br>
							①이 약관에서 정하지 아니한 사항이나 해석에 대해서는 관계법령 또는 상관례에 따릅니다.</li>
		                  <li><span>제 5 조 (이용계약 체결)</span><br>
							...
							⑦"회사"는 "회원"에 대해 회사정책에 따라 이용시간, 이용횟수, 서비스 메뉴 등을 세분하여 이용에 차등을 둘 수 있습니다.</li>
		                  <li><span>제 6 조 (회원정보의 변경)</span><br>
							...
							③제2항의 변경사항을 "회사"에 알리지 않아 발생한 불이익에 대하여 "회사"는 책임지지 않습니다.</li>
		                  <li><span>제 7 조 (개인정보보호 의무)</span><br>
							"정보통신망법" 등 관계 법령이 정하는 바에 따라 "회원"의 개인정보를 보호하기 위해 노력합니다. 개인정보의 보호 및 사용에 대해서는 관련법 및 "회사"의 개인정보처리방침이 적용됩니다. 다만, "회사"의 공식 사이트 이외의 링크된 사이트에서는 "회사"의 개인정보처리방침이 적용되지 않습니다.</li>
		                  <li><span>제 8 조 ("회원"의 "아이디" 및 "비밀번호"의 관리에 대한 의무)</span><br>
							...
							④제3항의 경우에 해당 "회원"이 "회사"에 그 사실을 통지하지 않거나, 통지한 경우에도 "회사"의 안내에 따르지 않아 발생한 불이익에 대하여 "회사"는 책임지지 않습니다.</li>
		                  <li><span>제 9 조 ("회원"에 대한 통지)</span><br>
							①"회사"가 "회원"에 대한 통지를 하는 경우 이 약관에 별도 규정이 없는 전자우편주소로 할 수 있습니다.<br>
							②"회사"는 "회원" 전체에 대한 통지의 경우 7일 이상 "회사"의 게시판에 게시함으로써 제1항의 통지에 갈음할 수 있습니다.</li>
		                  <li><span>제 10 조 ("회사"의 의무)</span><br>
							...
							③"회사"는 서비스이용과 관련하여 "회원"으로부터 제기된 의견이나 불만이 정당하다고 인정할 경우에는 이를 처리하여야 합니다. "회원"이 제기한 의견이나 불만사항에 대해서는 게시판을 활용하거나 전자우편 등을 통하여 "회원"에게 처리과정 및 결과를 전달합니다.</li>
						<li><span>제 11 조 ("회원"의 의무)</span><br>
							...
							②"회원"은 관계법, 이 약관의 규정, 이용안내 및 "서비스"와 관련하여 공지한 주의사항, "회사"가 통지하는 사항 등을 준수하여야 하며, 기타 "회사"의 업무에 방해되는 행위를 하여서는 안 됩니다.</li>
						<li><span>제 12 조 ("서비스"의 제공 등)</span><br>
							...
							⑤"회사"는 서비스의 제공에 필요한 경우 정기점검을 실시할 수 있으며, 정기점검시간은 서비스제공화면에 공지한 바에 따릅니다.</li>
						<li><span>제 13 조 ("서비스"의 변경)</span><br>
							...
							③"회사"는 무료로 제공되는 서비스의 일부 또는 전부를 회사의 정책 및 운영의 필요상 수정, 중단, 변경할 수 있으며, 이에 대하여 관련법에 특별한 규정이 없는 한 "회원"에게 별도의 보상을 하지 않습니다.<br></li>
						<li><span>제 14 조 (정보의 제공 및 광고의 게재)</span><br>
							...
							②"이용자(회원, 비회원 포함)"는 회사가 제공하는 서비스와 관련하여 게시물 또는 기타 정보를 변경, 수정, 제한하는 등의 조치를 취하지 않습니다.</li>
						<li><span>제 15 조 ("게시물"의 저작권)</span><br>
							①"회원"이 "서비스" 내에 게시한 "게시물"의 저작권은 해당 게시물의 저작자에게 귀속됩니다.<br>
							②"회원"이 "서비스" 내에 게시하는 "게시물"은 검색결과 내지 "서비스" 및 관련 프로모션 등에 노출될 수 있으며, 이 경우, 회사는 저작권법 규정을 준수하며, "회원"은 언제든지 고객센터를 통해 해당 게시물에 대해 삭제 등의 조치를 취할 수 있습니다.</li>
						<li><span>제 16 조 ("게시물"의 관리)</span><br>
							...
							- 게시중단요청서비스 : support@greatkorea.co</li>
						<li><span>제 17 조 (권리의 귀속)</span><br>
							①"서비스"에 대한 저작권 및 지적재산권은 "회사"에 귀속됩니다. 단, "회원"의 "게시물" 및 제휴계약에 따라 제공된 저작물 등은 제외합니다.<br>
							②"회사"는 서비스와 관련하여 "회원"에게 "회사"가 정한 이용조건에 따라 계정, "아이디", 콘텐츠 등을 이용할 수 있는 이용권만을 부여하며, "회원"은 이를 양도, 판매, 담보제공 등의 처분행위를 할 수 없습니다.</li>
						<li><span>제 18 조 (포인트)</span><br>
							"회사"는 서비스의 효율적 이용 및 운영을 위해 사전 공지 후 "포인트"의 일부 또는 전부를 조정할 수 있으며, "포인트"는 회사가 정한 기간에 따라 주기적으로 소멸할 수 있습니다.</li>
						<li><span>제 19 조 (계약해제, 해지 등)</span><br>
							...
							③"회원"이 계약을 해지하는 경우, 방명록에 등록된 "게시물" 은 삭제되지 않으니 사전에 삭제 후 탈퇴하시기 바랍니다.</li>
						<li><span>제 20 조 (이용제한 등)</span><br>
							①"회사"는 "회원"이 이 약관의 의무를 위반하거나 "서비스"의 정상적인 운영을 방해한 경우, 경고, 일시정지, 영구이용정지 등으로 "서비스" 이용을 단계적으로 제한할 수 있습니다.<br>
								...
								⑥"회원"은 본 조에 따른 이용제한 등에 대해 "회사"가 정한 절차에 따라 이의신청을 할 수 있습니다. 이 때 이의가 정당하다고 "회사"가 인정하는 경우 "회사"는 즉시 "서비스"의 이용을 재개합니다.</li>
						<li><span>제 21 조 (책임제한)</span><br>
							...
							⑤"회사"는 무료로 제공되는 서비스 이용과 관련하여 관련법에 특별한 규정이 없는 한 책임을 지지 않습니다.</li>
						<li><span>제 22 조 (준거법 및 재판관할)</span><br>
							...
							③해외에 주소나 거소가 있는 '회원' 의 경우 '회사'와 '회원'간 발생한 분쟁에 관한 소송은 전항에도 불구하고 대한민국 서울중앙지방법원을 관할 법원으로 합니다.</li>
					 </ul>
				  </div>                       
		    </section>
		 </div>
